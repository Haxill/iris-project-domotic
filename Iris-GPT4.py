...
required_modules = ['openai', 'sqlite3', 'gTTS', 'pygame', 'datetime', 'speech_recognition', 'os', 'miio', 'Yeelight', 'requests', 'zipfile', 'feedparser', 'bs4', 'colorama', 'langdetect', 'mtranslate']
